...
const steps = [
  {
    ...
    description:
      "Registered hospitals submit patient cases with medical documentation and financial proof through a secure portal.",
  },
  {
    step: "02",
    icon: Cpu,
    ...
    description:
      "Our AI engine validates treatment costs, detects duplicates, benchmarks pricing, and assigns confidence scores.",
  },
  {
    step: "03",
    icon: Landmark,
    ...
    description:
      "Verified cases are matched with university CSR funds. Transparent disbursement with complete audit trails.",
  },
];
...
const topContributors = [
  {
    ...
    amount: "₹2.4 Cr",
    cases: 84,
    logo: "/universities/iit-bombay.png",
  },
  {
    name: "AIIMS Delhi",
    amount: "₹1.9 Cr",
  ...
  },
  {
    ...
    amount: "₹1.7 Cr",
    cases: 58,
    logo: "/universities/iit-madras.png",
  },
  {
    name: "BITS Pilani",
    amount: "₹1.3 Cr",
    cases: 45,
    logo: "/universities/bits-pilani.png",
  },
  {
    name: "IISc Bangalore",
    amount: "₹1.1 Cr",
  ...
  },
  {
    ...
    amount: "₹92 L",
    cases: 31,
    logo: "/universities/iit-delhi.png",
  },
  {
    name: "VIT Vellore",
    amount: "₹85 L",
    cases: 28,
    logo: "/universities/vit-vellore.png",
  },
  {
    name: "IIT Kanpur",
    amount: "₹78 L",
    cases: 26,
    logo: "/universities/iit-kanpur.png",
  },
  {
    name: "MAHE Manipal",
    amount: "₹72 L",
              ...
              >
                <div className="w-14 h-14 rounded-lg bg-primary-foreground/25 flex items-center justify-center shrink-0 overflow-hidden border border-primary-foreground/10">
                  {uni.logo ?
                    ...
                    />
                  : <span className="text-sm font-bold text-accent text-center px-1">
                      {(uni as any).initials}
                    </span>
                  }
                </div>
                    ...
                    return (
                      ...
                      >
                        <div className="relative bg-primary-foreground/10 rounded-full p-2 border border-primary-foreground/20 hover:bg-primary-foreground/15 transition-colors text-center w-24 h-24 flex flex-col items-center justify-center">
                          <span className="text-lg font-black text-accent/30 absolute top-0.5">
                            {step.step}
                          </span>
                          ...
                          <h4 className="text-xs font-semibold text-primary-foreground mb-0.5">
                            {step.title}
                          </h4>
                        </div>
                      </div>
      ...
      <section className="py-20">
        <div className="container text-center">
          ...
          <p className="text-muted-foreground mb-8 max-w-lg mx-auto">
            Join JeevanDhara's verified network as a hospital or university
            partner and help save lives through transparent, AI-validated
            funding.
          </p>
